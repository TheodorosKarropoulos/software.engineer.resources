...
- [Copy-paste programming](anti-patterns/copy-paste-programming.md): Copying and pasting code without understanding how it works or modifying it to fit the specific context.
- [God object](anti-patterns/god-object.md): A class that has too many responsibilities and becomes difficult to maintain.
- [Leaky abstractions](anti-patterns/leaky-abstraction.md): Abstractions that break down or "leak" implementation details, making the code harder to understand and maintain.
- [Accidental complexity](anti-patterns/accidental-complexity.md): Adding unnecessary complexity to the codebase, making it harder to understand and maintain.
